...
module.exports = fp(async function (fastify, opts) {
  // Only register if we're using Dapr AND the sendMessage function isn't already decorated
  if (process.env.USE_DAPR_PUBSUB === "true" && !fastify.hasDecorator("sendMessage")) {
    ...
    console.log(
      "Dapr pub/sub not enabled or sendMessage already decorated, skipping Dapr messagequeue plugin"
    )
  }
})
