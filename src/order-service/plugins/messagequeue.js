...
module.exports = fp(async function (fastify, opts) {
  // Only register if NOT using Dapr AND the sendMessage function isn't already decorated
  if (process.env.USE_DAPR_PUBSUB !== "true" && !fastify.hasDecorator("sendMessage")) {
    ...
    console.log(
      "Using Dapr pub/sub or sendMessage already decorated, skipping standard messagequeue plugin"
    )
  }
})
